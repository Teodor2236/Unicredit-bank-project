...
public class ClientRequestController {
	...
	public ResponseEntity<List<ClientRequestDTO>> getAll(
		...
		List<ClientRequestDTO> clientRequests = clientRequestService.getAll(actionType, fromDate, toDate);
	...
	public ResponseEntity<List<ClientRequestDTO>> getByClientIdAndProductDetailsId(@RequestParam Long clientId,
			@RequestParam Long productDetailsId) {
		List<ClientRequestDTO> clientRequests = clientRequestService.getByClientIdAndProductDetailsId(clientId,
				productDetailsId);
		if (clientRequests.isEmpty()) {
			return ResponseEntity.noContent().build();
		}
